...
export default function Services({ onBooking }) {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-br from-white via-amber-50 to-amber-100">
              ...
              {servicesToShow.map((service) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="font-playfair text-2xl font-semibold text-gray-800 mb-3 group-hover:text-amber-600 transition-colors duration-300">
                      {service.title}
                    </h3>
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                      ...
                      <button 
                        ...
                        className="text-amber-500 cursor-pointer hover:text-white hover:bg-amber-500 font-medium py-2 px-4 rounded-full transition-all duration-300 border border-amber-500 text-sm"
                      >
                        Réserver
                      </button>
                    </div>
